...
- When a user is selected, it should fire a state update that runs 
  an effect which saves that user to sessionStorage. 
- Add another effect that runs when the component loads in order to 
  check if there is a saved user in sessionStorage 
